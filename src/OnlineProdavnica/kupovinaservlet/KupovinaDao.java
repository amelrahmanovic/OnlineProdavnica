...
public class KupovinaDao {
	public void New(String ime, String prezime, String proizvodid, String proizvod, String DrzavaId, String Adresa)
	{
		try {
			...
			st.executeUpdate("INSERT INTO `onlineprodavnica`.`kupovina`\r\n" + 
					"(`ProizvodId`, `NazivProizvoda`, `Ime`, `Prezime`, `DatumKupovine`, `DrzavaId`, `Adresa`)\r\n" + 
					"VALUES\r\n" + 
					"("+proizvodid+", '"+proizvod+"', '"+ime+"', '"+prezime+"', '"+dtf.format(now).toString()+"', '"+DrzavaId+"', '"+Adresa+"');\r\n" + 
					"");
		} catch (Exception e) {
